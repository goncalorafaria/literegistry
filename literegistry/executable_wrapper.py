...
from literegistry.runtime import LocalRuntime, Runtime
...
class ExecutableWrapper(ABC):
    ...
    def get_model_args(self) -> list:
        """Return command-line arguments that identify the served model."""
        return [self.get_model_flag(), self.model]

    def get_extra_args(self) -> list:
        """Return command-line arguments generated from extra kwargs."""
        args = []
    ...
    def build_backend_command(self) -> list:
        """Build the backend command before runtime-specific wrapping."""
        return (
    ...
    def start_server(self):
        ...
        cmd = self.runtime.build_command(self.build_backend_command())
