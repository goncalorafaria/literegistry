...
class StackCommand:
    ...
    def __call__(
        ...
        config = PodmanStackConfig(
            ...
            podman_max_sessions=podman_max_sessions,
            podman_session_memory=podman_session_memory,
            podman_session_pids_limit=podman_session_pids_limit,
            podman_session_idle_timeout=podman_session_idle_timeout,
            podman_janitor_interval=podman_janitor_interval,
            podman_resource_watchdog_interval=podman_resource_watchdog_interval,
            podman_image_prune_until=podman_image_prune_until,
            docker_mirror_image=docker_mirror_image,
            warmup_image=warmup_image,
            warmup_enabled=warmup_enabled,
            warmup_concurrency=warmup_concurrency,
            warmup_checkpoint_file=warmup_checkpoint_file,
