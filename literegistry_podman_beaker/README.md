...
The runtime images pin `literegistry==1.0.49`, including the gateway, Redis,
Podman, mirror, warmup, and live-fire images. Make version 1.0.49 available on
...
# python -m twine upload dist/literegistry-1.0.49*
```
