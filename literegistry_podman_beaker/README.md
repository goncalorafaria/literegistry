...
The runtime images pin `literegistry==1.0.54`, including the gateway, Redis,
Podman, mirror, warmup, and live-fire images. Make version 1.0.54 available on
...
# python -m twine upload dist/literegistry-1.0.54*
```
...
Publish `literegistry==1.0.54` and `literegistry-podman-beaker==0.2.17` to the
